...
getFlavorByIndex(originalFlavors, 7);
...
function copy(originalFlavors) {
  originalFlavors.push("Vanilla", "Vanilla Burnt Almond");
  originalFlavors.shift();
  const cloneOGFlavors = [...originalFlavors];
  console.log(cloneOGFlavors);
}
...
function getAverageWordLength(originalFlavors) {
  var avgarray = originalFlavors.join();
  avgarray = avgarray.replace(/,/g, " ");
  //console.log(avgarray);
  //console.log(originalFlavors.length);
  avgWordLength = avgarray.split(" ").length / originalFlavors.length;
...
function getRandomFlavors(
  ...
  var combineFlavors = originalFlavors.concat(
    newFlavors,
    seasonalFlavors,
    regionalFlavors
  );
  //console.log(combineFlavors)
  combineFlavors.sort(() => Math.random() - 0.5);
  randomFlavors = combineFlavors.slice(0, 31);
